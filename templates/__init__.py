...
def index():
    ...
    extend_([u'        <input class="input" type="text" name="mista" placeholder="Mist\xe4" autocomplete="off" required/>\n'])
    extend_([u'    </div>\n'])
    extend_([u'  </div>\n'])
    extend_([u'\n'])
    extend_([u'  <div class="control-group">\n'])
    ...
    extend_([u'    <div class="controls">\n'])
    extend_([u'      <input type="text" name="mihin" placeholder="Mihin" autocomplete="off" required/>\n'])
    extend_([u'    </div>\n'])
    extend_([u'  </div>\n'])
    extend_([u'\n'])
    extend_([u'  <div class="control-group">\n'])
    ...
    extend_([u'    <div class="controls">\n'])
    extend_([u'      <input type="text" id="datepicker1" name="lahtopvm"/>\n'])
    extend_([u'    </div>\n'])
    extend_([u'  </div>\n'])
    extend_([u'\n'])
    extend_([u'  <div class="control-group">\n'])
    ...
    extend_([u'    <div class="controls">\n'])
    extend_([u'      <input type="text" name="lahtoaika" placeholder="02:01"/>\n'])
    extend_([u'    </div>\n'])
    extend_([u'  </div>\n'])
    extend_([u'\n'])
    extend_([u'  <div class="control-group">\n'])
    ...
    extend_([u'    <div class="controls">\n'])
    extend_([u'      <input type="text" id="datepicker2" name="saapumispvm"/>\n'])
    extend_([u'    </div>\n'])
    extend_([u'  </div>\n'])
    extend_([u'\n'])
    extend_([u'  <div class="control-group">\n'])
    ...
    extend_([u'    <div class="controls">\n'])
    extend_([u'      <input type="text" name="saapumisaika" placeholder="02:01"/>\n'])
    extend_([u'    </div>\n'])
    extend_([u'  </div>\n'])
    extend_([u'\n'])
    extend_([u'  <div class="control-group">\n'])
    ...
    extend_([u'  };\n'])
    extend_([u'  ', u'$', u'("#datepicker1,#datepicker2").datepicker(dpSettings);\n'])
    extend_([u'\n'])
