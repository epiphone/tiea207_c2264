...
def info():
    ...
    extend_([u'      <div class="controls">\n'])
    extend_([u'        <a class="btn btn-primary" href="/index"><i class="icon-arrow-left icon-white"></i> Takaisin p\xe4\xe4sivulle</a>\n'])
    extend_([u'      </div>\n'])
    extend_([u'    </div>\n'])
    extend_([u'\n'])
    extend_([u'</div> <!-- /.form-container -->\n'])
...
def palaute():
    ...
    extend_([u'\n'])
    extend_([u'   <iframe class="hidden-phone" src="./Joukkoliikenteen hintavertailu - palaute_files/viewform.htm" width="550" height="655" frameborder="0" marginheight="0" marginwidth="0">Loading...</iframe>\n'])
    extend_([u'\n'])
