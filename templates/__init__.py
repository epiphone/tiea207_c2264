...
def index():
    ...
    extend_([u'<div class="hidden-phone banner" id="banneri">\n'])
    extend_([u'  <h1>Mill\xe4 matkaan?</h1>\n'])
    extend_([u'  <p>Julkisen liikenteen ja henkil\xf6autoilun vertailusovellus<p>\n'])
    extend_([u'</div>\n'])
    extend_([u'<div class="visible-phone banner" style="text-align: center; background-color: #EEEEEE">\n'])
...
def results_vis (matkat, params, t, dt):
    ...
    extend_([u'  <h3>Hae yhteyksi\xe4</h3>\n'])
    ...
    extend_([u'    <input class="input" id="inputMista" type="text" name="mista" autocomplete="off" required="" autofocus="" pattern="[a-zA-Z\xe4\xc4\xe5\xc5\xf6\xd6]+">\n'])
    extend_([u'    <label>Minne</label>\n'])
    extend_([u'    <input id="inputMihin" type="text" name="mihin" autocomplete="off" required="" "[a-zA-Z\xe4\xc4\xe5\xc5\xf6\xd6]+">\n'])
    extend_([u'    <div class="breaker"></div>\n'])
    extend_([u'    <br>\n'])
    extend_([u'    <label>Aika ja Pvm</label>\n'])
    extend_([u'    <input type="text" class="input-xmini" id="inputTunnit" name="h" pattern="[0-9]|0[0-9]|1[0-9]|2[0-3]">\n'])
    extend_([u'    <small>:</small>\n'])
    extend_([u'    <input type="text" class="input-xmini" id="inputMinuutit" name="min" pattern="[0-9]|0[0-9]|[1-5][0-9]">\n'])
    extend_([u'    <input type="text" class="input-small" id="inputPvm" name="pvm" pattern="([1-9]|1[0-9]|2[0-9]|3[1]).([1-9]|1[12]).[0-9]{4}">\n'])
    extend_([u'    <br>\n'])
    extend_([u'    <div id="datepicker"></div>\n'])
    extend_([u'    <select id="inputAikatyyppi" class="input-medium" name="tyyppi">\n'])
    extend_([u'        <option>L\xe4ht\xf6aika</option>\n'])
    extend_([u'        <option>Saapumisaika</option>\n'])
    extend_([u'    </select>\n'])
    extend_([u'    <div class="breaker"></div>\n'])
    extend_([u'    <br>\n'])
    extend_([u'    <label>Alennusluokka</label>\n'])
    extend_([u'    <select id="inputAlennusluokka" class="input-medium" name="luokka">\n'])
    extend_([u'      <option value="0">Aikuinen</option>\n'])
    extend_([u'      <option value="1">Lapsi(4-11 v)</option>\n'])
    extend_([u'      <option value="3">Nuori(12-16 v)</option>\n'])
    extend_([u'      <option value="2">Opiskelija</option>\n'])
    extend_([u'      <option value="5">Varusmies</option>\n'])
    extend_([u'      <option value="7">Siviilipalvelusmies</option>\n'])
    extend_([u'      <option value="4">El\xe4kel\xe4inen</option>\n'])
    ...
    extend_([u'    <select id="inputKeskikulutus" class="input-large" name="kulutus">\n'])
    extend_([u'      <option value="95|4,5">95E, Pieni (4,5l/100km)</option>\n'])
    extend_([u'      <option value="95|6,5">95E, Keski(6,5l/100km)</option>\n'])
    extend_([u'      <option value="95|8,5">95E, Suuri (8,5l/100km)</option>\n'])
    extend_([u'      <option class="select-dash" disabled="disabled">----</option>\n'])
    extend_([u'      <option value="98|4,5">98E, Pieni (4,5l/100km)</option>\n'])
    extend_([u'      <option value="98|6,5">98E, Keski (6,5l/100km)</option>\n'])
    extend_([u'      <option value="98|8,5">98E, Suuri (8,5l/100km)</option>\n'])
    extend_([u'      <option class="select-dash" disabled="disabled">----</option>\n'])
    extend_([u'      <option value="Di|3,7">Di, Pieni (3,7l/100km)</option>\n'])
    extend_([u'      <option value="Di|5,7">Di, Keski (5,7l/100km)</option>\n'])
    extend_([u'      <option value="Di|7,7">Di, Suuri (7,7l/100km)</option>\n'])
    extend_([u'    </select>\n'])
    extend_([u'    <br>\n'])
    extend_([u'\n'])
    extend_([u'    <label class="checkbox inline">\n'])
    ...
    extend_([u'    </label>\n'])
    extend_([u'    <br>\n'])
    extend_([u'    <button class="btn-custom" type="submit">Hae yhteyksi\xe4<i class="icon-search"></i></button>\n'])
    extend_([u'  </form>\n'])
    ...
    extend_([u'  <div class="btn-group">\n'])
    extend_([u'    <button class="btn btn-primary" onclick="sortByDt1()">L\xe4ht\xf6</button>\n'])
    extend_([u'    <button class="btn btn-primary" onclick="sortByDt2()">Saapuminen</button>\n'])
    extend_([u'    <button class="btn btn-primary" onclick="sortByDuration()">Kesto</button>\n'])
    extend_([u'    <button class="btn btn-primary" onclick="sortByPrice()">Hinta</button>\n'])
    extend_([u'    <button class="btn btn-primary" onclick="sortByTransfers()">Vaihdot</button>\n'])
    extend_([u'  </div>\n'])
    extend_([u'</div>\n'])
    extend_([u'\n'])
